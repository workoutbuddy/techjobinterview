(function () {
    var k = this || self, l = function (a, b) {
        a = a.split(".");
        var c = k;
    ...
    var y = /:[0-9]+$/, A = function (a, b) {
        ...
        switch (b) {
            ...
            case "path":
                ...
                a = a.split("/");
                a:if (b = a[a.length - 1], c = [], Array.prototype.indexOf) b = c.indexOf(b), b = "number" == typeof b ? b : -1; else {
    ...
    var D, F, G = function (a) {
        ...
        for (var b = [], c = 0; c < a.length; c += 3) {
            var d = c + 1 < a.length, e = c + 2 < a.length, g = a.charCodeAt(c), f = d ? a.charCodeAt(c + 1) : 0,
                h = e ? a.charCodeAt(c + 2) : 0, m = g >> 2;
            g = (g & 3) << 4 | f >> 4;
            f = (f & 15) << 2 | h >> 6;
            h &= 63;
            e || (h = 64, d || (f = 64));
    ...
    var P = /(.*?)\*(.*?)\*(.*)/, Q = /([^?#]+)(\?[^#]*)?(#.*)?/, R = /(.*?)(^|&)_gl=([^&]*)&?(.*)/, T = function (a) {
        ...
        return function (b) {
            var c = B(r.location.href), d = c.search.replace("?", "");
            a:{
                var e = d.split("&");
...
(function () {
    ...
    var gb = Za || "ga", jd = /^(?:utma\.)?\d+\.\d+$/, kd = /^amp-[\w.-]{22,64}$/, Ba = !1;
    var vd = new $c;
    ...
    }, f = /^[\w\-:/.?=&%!\[\]]+$/, Nd = /^[\w+/_-]+[=]{0,2}$/, be = function (a, b) {
    ...
    var ad = void 0, bd = function (a) {
        return ad ? ad : (a ? "https:" : Ba || "https:" == M.location.protocol ? "https:" : "http:") + "//www.google-analytics.com"
    }, Da = function (a) {
        this.name = "len";
        this.message = a + "-8192"
    }, ba = function (a, b, c) {
        ...
        1 <=
        100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j77", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(ad ? ad + "/33" : bd(!0) + "/u/d", a.join("&"), ua))
    };
    var h = function (a) {
    ...
    function Sa(a) {
        var b = P(a, gd) || (ad ? ad + "/3" : bd(!1) + "/collect"), c = a.get(qe), d = P(a, fa);
        !d && a.get(Vd) && (d = "beacon");
        if (c) pe(b, P(a, Ra), c, a.Z(Ia)); else if (d) {
            c = d;
            d = P(a, Ra);
            var e = a.Z(Ia);
            e = e || ua;
    ...
    var Qb = T("_oot"), dd = S("previewTask"), Rb = S("checkProtocolTask"), md = S("validationTask"),
        ...
        ie = T("_gclsrc"), je = T("storeGac", void 0, !0), oe = T("_x_19"),
        gd = S("transportUrl"), Md = S("_r", "_r"), qe = S("_dp"), Ud = S("allowAdFeatures", void 0, !0);
    ...
    var te = function () {
        if (ad) return !0;
        for (var a = M.getElementsByTagName("script"), b = 0; b < a.length && 100 > b; b++) {
            var c = (c = a[b].src) ? 0 != c.indexOf(bd(!0) + "/analytics") ? !1 : !0 : !1;
            if (c) return !0
        }
        return !1
    };
    ...
    function fc() {
        ...
        return function (b) {
            if ("pageview" == b.get(Va) && !a.I) {
                a.I = !0;
                var c = aa(b), d = 0 < E(P(b, kb), "gclid").length;
                (c || d) && gc(function (e) {
                    c && a.send("timing", e);
                    d && a.send("adtiming", e)
                })
        ...
        if ("cookie" == P(a, ac)) {
            ...
            if (a.get(je)) {
                ...
                if (c) {
                    ...
                    a.data.set(he, d);
                    b = {};
                    var e = P(a, fe), g = P(a, ie), ca = kc(P(a, Yb)), l = lc(P(a, W));
                    a = P(a, Na);
    ...
    };var od = new RegExp(/^https?:\/\/([^\/:]+)/), De = O.google_tag_data.glBridge,
        pd = /(.*)([?&#])(?:_ga=[^&#]*)(?:&?)(.*)/, me = /(.*)([?&#])(?:_gac=[^&#]*)(?:&?)(.*)/;
    ...
    var Sd = function (a) {
        if (!a.get("dcLoaded") && "cookie" == a.get(ac)) {
            ...
            if (se(a)) {
                var c = ne() !== H(b, a);
                a.set(Md, 1, !0);
                c ? (J(79), a.set(gd, ad ? ad + "/32" : bd(!1) + "/j/collect", !0), a.set(qe, {
                    U: re(b, a, 1),
                    google: re(b, a, 2),
                    count: 0
                }, !0)) : a.set(gd, ad ? ad + "/31" : bd(!1) + "/r/collect", !0)
            }
        }
    };
    var Lc = function () {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function (a) {
        ...
        if (a.get(Hd) && (c = be("_ga", !!a.get(cc)), g = be("_gl", !!a.get(cc)), d = De.get(a.get(cc)), e = d._ga, g && 0 < g.indexOf("_ga*") && !e && J(30), g = d.gclid, ca = d._gac, c || e || g || ca)) if (c && e && J(36), a.get(bc) || ye(a.get(Kd))) {
            if (e && (J(38), a.data.set(Q, e), d._gid && (J(51), a.data.set(I, d._gid))), g ? (J(82), a.data.set(ce, g), d.gclsrc && a.data.set(ie, d.gclsrc)) : ca && (d = ca.split(".")) && 2 === d.length && (J(37), a.data.set(ce,
                d[0]), a.data.set(fe, d[1])), c) b:if (d = c.indexOf("."), -1 == d) J(22); else {
                e = c.substring(0, d);
                g = c.substring(d + 1);
                d = g.indexOf(".");
                c = g.substring(0, d);
                ...
                J(11);
                a.data.set(Q, d);
                if (c = be("_gac", !!a.get(cc))) c = c.split("."), "1" != c[0] || 4 != c.length ? J(72) : ke(c[3], c[1]) ? J(71) : (a.data.set(ce,
                    c[3]), a.data.set(fe, c[2]), J(70))
            }
        } else J(21);
    ...
    var u = function (a, b, c) {
        ...
        if (!ea(Yd.get(b)) && !$d.get(b)) {
            ...
            if (c && (c && 0 <= c.indexOf("/") || (c = (ad ? ad + "/34" : bd(!1) + "/plugins/ua/") + c), d = ae(c), a = d.protocol, c = M.location.protocol, ("https:" == a || a == c || ("http:" != a ? 0 : "http:" == c)) && B(d))) {
                if (d =
        ...
        function b(l) {
            var k = l.hostname || "", w = 0 <= k.indexOf("]");
        ...
        d = b(c);
        return {
            protocol: (c.protocol || "").toLowerCase(), host: d[0],
            port: d[1], path: d[2], query: c.search || "", url: a || ""
        }
    };
    var Z = {
        ga: function () {
