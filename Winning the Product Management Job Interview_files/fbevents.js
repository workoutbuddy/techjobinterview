    ...
    (function () {
        ...
        f.ensureModuleRegistered("SignalsFBEventsPlugin", function () {
            return function (f, g, h, d) {
                ...
                (function () {
                    "use strict";
                    var a = function a(b) {
                        i(this, a), this.__fbEventsPlugin = 1, this.plugin = b, this.__fbEventsPlugin = 1
                    };
                    e.exports = a
                })();
                return e.exports
        ...
        f.ensureModuleRegistered("SignalsFBEventsUtils", function () {
            return function (f, b, c, d) {
                ...
                (function () {
                    "use strict";
                    var a = Object.prototype.toString, c = !("addEventListener" in b);
                    ...
                    function l(a, b, d) {
                        ...
                        var f = c ? a.detachEvent : a.removeEventListener, g = function b() {
                            f && f.call(a, e, b, !1), d()
                        };
                        b && b.call(a, e, g, !1)
                    }

                    var m = Object.prototype.hasOwnProperty, n = !{toString: null}.propertyIsEnumerable("toString"),
            ...
            return function (g, h, i, d) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsOptTrackingOptions"),
                        ...
                        d = f.getFbeventsModules("SignalsFBEventsUtils"), h = d.some, i = !1;
                    ...
                    function o() {
                        ...
                        if (a) return !0;
                        a = g.document;
                        for (var b in a) if (b.match(/\$[a-z]dc_/) && a[b].cache_) return !0;
                    ...
                    d = new b(function (b, d) {
                        ...
                        b.on("getCustomParameters", function (f) {
                            var i = d.optIns,
                                m = l(f != null && i.isOptedOut(f.id, "AutomaticSetup"), a.AUTO_CONFIG_OPT_OUT);
                            i = l(f != null && i.isOptedIn(f.id, "AutomaticSetup"), a.AUTO_CONFIG);
                            var n = l(b.disableConfigLoading !== !0, a.CONFIG_LOADING),
                                o = l(j(), a.SUPPORTS_DEFINE_PROPERTY), p = l(k(), a.SUPPORTS_SEND_BEACON),
                                q = l(f != null && g[f.id], a.HAS_CONFLICTING_PII),
                                s = l(f != null && e[f.id], a.HAS_INVALIDATED_PII);
                            f = l(f != null && h[f.id], a.HAS_AUTOMATCHED_PII);
                            var t = l(c.getShouldProxy(), a.SHOULD_PROXY), u = r();
                            m = m | i | n | o | p | s | t | u.isHeadless | u.isSelenium | u.hasDetectionFailed | q | f;
                            return {o: m}
                        });
                        i = !0
                    });
    ...
    (function () {
        ...
        f.ensureModuleRegistered("SignalsEvents", function () {
            return function (g, h, j, d) {
                ...
                (function () {
                    ...
                    a = a.logError;
                    var b = f.getFbeventsModules("SignalsFBEventsUtils"), c = b.keys, d = 0;
                    b = function () {
                        function b() {
                            var a = this;
                            k(this, b);
                        ...
                        i(b, [{
                            ...
                            key: "_once", value: function (a, b) {
                                var c = arguments, d = this.on(a, function () {
                                    d();
                            ...
                            key: "_unsubscribe", value: function (a, b) {
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsLogging"), b = a.logUserError,
                        c = /^[+-]?\d+(\.\d+)?$/, d = "number", e = "currency_code", g = {
                            AED: 1,
                            ARS: 1,
                            AUD: 1,
                            BOB: 1,
                    ...
                    var h = {
                        ...
                        Subscribe: {},
                        ViewContent: {}
                    }, i = {agent: !0, automaticmatchingconfig: !0, codeless: !0}, j = Object.prototype.hasOwnProperty;
                    ...
                    function r(a, c) {
                        a = p(a, c);
                        a.error && b(a.error);
                        if (a.warnings) for (var c = 0; c < a.warnings.length; c++) b(a.warnings[c]);
                        return a
                    }
            ...
            return function (g, h, c, d) {
                ...
                (function () {
                    ...
                    var a = Object.assign || function (a) {
                        ...
                        o = f.getFbeventsModules("SignalsPixelEndpoint"), p = n.each, q = n.keys, r = n.map, s = n.some,
                        t = l.logError, u = l.logUserError, v = {
                            AutomaticMatching: !0,
                            FirstPartyCookies: !0,
                            IWLBootstrapper: !0,
                            IWLParameters: !0,
                    ...
                    function z(a, b, c) {
                        h.loadJSFile(h.CONFIG.CDN_BASE_URL + "signals/config/" + a + "?v=" + b + "&r=" + c)
                    }
                    ...
                    l = function () {
                        ...
                        i(e, [{
                            key: "optIn", value: function (a, b) {
                                var c = this, d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1;
                                if (typeof b !== "string" || !y(b)) throw new Error('Invalid Argument: "' + b + '" is not a valid opt-in feature');
                                y(b) && (this.optIns.optIn(a, b, d), p([b].concat(j(w[b] || [])), function (a) {
                                    x[a] && p(x[a], function (a) {
                            ...
                            key: "optOut", value: function (a, b) {
                                this.optIns.optOut(a, b);
                                return this
                            }
                        }, {
                            key: "consent", value: function (a) {
                                a === "revoke" ? this.locks.lockConsent() : a === "grant" ? this.locks.unlockConsent() : u({
                                    action: a,
                            ...
                            key: "setUserProperties", value: function (b, c) {
                            ...
                            key: "trackSingle", value: function (a, c, d, e) {
                                b.validateEventAndLog(c, d);
                                return this.trackSingleGeneric(a, c, d, e)
                            }
                        }, {
                            key: "trackSingleCustom", value: function (a, b, c, d) {
                                return this.trackSingleGeneric(a, b, c, d)
                            }
                        }, {
                            key: "trackSingleSystem", value: function (a, b, c, d) {
                                return this.trackSingleGeneric(b, c, d, null, a)
                            }
                        }, {
                            key: "trackSingleGeneric", value: function (a, b, c, d, e) {
                            ...
                            key: "_validateSend", value: function (a, c) {
                            ...
                            key: "_argsHasAnyUserData", value: function (a) {
                                var b = a.userData != null && q(a.userData).length > 0;
                                a = a.userDataFormFields != null && q(a.userDataFormFields).length > 0;
                                return b || a
                            }
                        }, {
                            key: "fire", value: function (a) {
                                var b = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
                                this._validateSend(a, b);
                                if (this._argsHasAnyUserData(a) && !this.fbq.loadPlugin("identity")) {
                                    g.fbq("fire", a);
                                    return this
                                }
                            ...
                            key: "callMethod", value: function (a) {
                                var b = a[0];
                            ...
                            key: "getDefaultSendData", value: function (a, b, c) {
                            ...
                            key: "getOptedInPixels", value: function (a) {
                                var b = this;
                            ...
                            key: "getPixel", value: function (a) {
                                return this.pixelsByID[a]
                            }
                        }, {
                            key: "loadConfig", value: function (a) {
                                ...
                                (!this.fbq.pendingConfigs || s(this.fbq.pendingConfigs, function (b) {
                                    return b === a
                                }) === !1) && z(a, this.VERSION, this.RELEASE_SEGMENT != null ? this.RELEASE_SEGMENT : "stable")
                            }
                        }, {
                            key: "configLoaded", value: function (a) {
                ...
                (function () {
                    ...
                    a = function () {
                        ...
                        i(a, [{
                            ...
                            key: "onUnlocked", value: function (a) {
                            ...
                            key: "lockPlugin", value: function (a) {
                                this.lock("plugin:" + a)
                            }
                        }, {
                            key: "releasePlugin", value: function (a) {
                                this.release("plugin:" + a)
                            }
                        }, {
                            key: "lockConfig", value: function (a) {
                                this.lock("config:" + a)
                            }
                        }, {
                            key: "releaseConfig", value: function (a) {
                                this.release("config:" + a)
                            }
                        }, {
                            key: "lockConsent", value: function () {
                                this.lock("consent")
                            }
                        }, {
                            key: "unlockConsent", value: function () {
        ...
        f.ensureModuleRegistered("SignalsFBEventsLogging", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsNetworkUtils"), b = a.sendPOST;
                    a = f.getFbeventsModules("SignalsFBEventsUtils");
                    var c = a.isInstanceOf, d = f.getFbeventsModules("SignalsParamList"), e = !1;
            ...
            return function (g, i, j, k) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsTelemetry"),
                        b = f.getFbeventsModules("SignalsFBEventsUtils"), c = b.each, d = "fbmq-0.1", i = {
                    ...
                    function s(a) {
                        var b = {};
                        if (a != null && (typeof a === "undefined" ? "undefined" : h(a)) === "object") for (var c in a) if (Object.prototype.hasOwnProperty.call(a, c)) {
                            var d = r(a[c]);
                            d != null && (b[q(c)] = d)
                        }
                        return b
                    ...
                    e.exports = {pixelHasActiveBridge: o, registerBridge: m, sendEvent: v}
                })();
                return e.exports
            }(a, b, c, d)
        });
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsProxyState"),
                        b = f.getFbeventsModules("SignalsFBEventsQE"), c = f.getFbeventsModules("SignalsFBEventsUtils"),
                        d = c.listenOnce;
                    ...
                    var j = {UNSENT: 0, OPENED: 1, HEADERS_RECEIVED: 2, LOADING: 3, DONE: 4};
                    c = function c() {
                        var e = this;
                        k(this, c);
                        ...
                        this._sendXHRPost = function (b, c, d) {
                            ...
                            var f = new XMLHttpRequest(), g = function () {
                                if (d != null) {
                            ...
                            if ("withCredentials" in f) f.withCredentials = !0, f.open("POST", c, !1), f.onreadystatechange = function () {
                                ...
                                f.status !== 200 && g()
                            }; else if (XDomainRequest != void 0) f = new XDomainRequest(), f.open("POST", c), f.onerror = g; else return !1;
                            f.send(b.toFormData());
                            return !0
                        };
                        this._sendFormPOST = function (c, f, j) {
                            ...
                            var l = "fb" + Math.random().toString().replace(".", ""), m = h.createElement("form");
                            m.method = "post";
                            m.action = i(f, j);
                            m.target = l;
                            m.acceptCharset = "utf-8";
                            m.style.display = "none";
                            var n = !!(g.attachEvent && !g.addEventListener), o = h.createElement("iframe");
                            n && (o.name = l);
                            o.src = "about:blank";
                            o.id = l;
                            o.name = l;
        ...
        f.ensureModuleRegistered("SignalsFBEventsOptIn", function () {
            return function (g, h, c, d) {
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsUtils"), b = a.each, c = a.filter, d = a.keys,
                        g = a.some;
                    ...
                    a = function () {
                        ...
                        i(a, [{
                            key: "_getOpts", value: function (a) {
                                return [].concat(j(Object.prototype.hasOwnProperty.call(this._subOpts, a) ? this._subOpts[a] : []), [a])
                            }
                        }, {
                            key: "_setOpt", value: function (a, b, c) {
                                b = this._opts[b] || (this._opts[b] = {});
                                b[a] = c
                            }
                        }, {
                            key: "optIn", value: function (a, c) {
                                var d = this, e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1;
                            ...
                            key: "isOptedIn", value: function (a, b) {
                                return this._opts[b] != null && this._opts[b][a] === !0
                            }
                        }, {
                            key: "isOptedOut", value: function (a, b) {
                                return this._opts[b] != null && this._opts[b][a] === !1
                            }
                        }, {
                            key: "listPixelIds", value: function (a) {
                                var b = this._opts[a];
            ...
            return function (g, j, c, d) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsConfigStore"),
                        ...
                        c = f.getFbeventsModules("SignalsFBEventsLogging"), d = c.logError,
                    ...
                    c = function () {
                        function c(a, b) {
                            k(this, c), this._loadedPlugins = {}, this._instance = a, this._lock = b
                        }

                        i(c, [{
                            key: "registerPlugin", value: function (b, c) {
                            ...
                            key: "loadPlugin", value: function (a) {
                                ...
                                a = b.CONFIG.CDN_BASE_URL + "signals/plugins/" + a + ".js?v=" + f.version;
            ...
            return function (f, i, j, k) {
                ...
                (function () {
                    ...
                    function b(a) {
                        var b = g(a, 1);
                        b = b[0];
                        return a.length === 1 && Array.isArray(b) ? {args: b, isLegacySyntax: !0} : {
                            args: a,
                            isLegacySyntax: !1
                        }
                    }
        ...
        f.ensureModuleRegistered("SignalsFBEventsTelemetry", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsLogging"),
                        b = f.getFbeventsModules("SignalsFBEventsNetworkUtils"), c = b.sendPOST,
                        d = f.getFbeventsModules("SignalsParamList");
                    b = .01;
                    var e = Math.random(), h = g.fbq && g.fbq._releaseSegment ? g.fbq._releaseSegment : "unknown",
                        i = e < b || h === "canary";
                    ...
                    k.exports = {logStartBatch: l, logEndBatch: m, logMobileNativeForwarding: n}
                })();
                return k.exports
            }(a, b, c, d)
        });
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsEvents"),
                        ...
                        e = f.getFbeventsModules("SignalsParamList"), j = a.trigger,
                        l = {ENDPOINT: "https://www.facebook.com/tr/", PROXY_ENDPOINT: null}, m = g.top !== g, n = !1;
                    a = function (a) {
                        n = a
                    };
                    a(s());
                    ...
                    function o(a) {
                        var b = a.customData, c = a.customParams, d = a.eventName, f = a.id;
                        a = a.piiTranslator;
                        a = new e(a);
                        a.append("id", f);
                        a.append("ev", d);
                    ...
                    function r(a) {
                        var e = a.customData, f = a.customParams, g = a.eventName;
                        a = o(a);
                        var h = c.get();
                        if (h != null) {
                            var i = h.name === "send_coalescence_telemetry";
                            i && p === 0 && h.isInExperimentGroup && (d.logStartBatch(), setTimeout(q, 0));
                            h.name === "a_a_test_experiment" && a.append("exp", h.code)
                        }
                        p++;
                        i = !!f && f.containsKey("es") && f.get("es") === "timespent";
                        h = [a, l.ENDPOINT, l.PROXY_ENDPOINT];
                        if ((i || !n && g === "SubscribedButtonClick") && b.sendBeacon.apply(b, h)) {
                            j("fired", "BEACON", a, e);
                            return
                        }
                    ...
                    function s() {
                        var a = g.chrome, b = g.navigator, c = b.vendor, d = g.opr !== void 0,
                    ...
                    k.exports = {CONFIG: l, sendBeaconPII: t, sendEvent: r, setIsChrome: a}
                })();
                return k.exports
            }(a, b, c, d)
        });
        f.ensureModuleRegistered("SignalsFBEvents", function () {
            return function (g, h, i, k) {
                ...
                (function () {
                    ...
                    var b = a.getFbeventsModules("SignalsFBEventsQE"), c = a.getFbeventsModules("SignalsParamList"),
                        d = a.getFbeventsModules("SignalsPixelEndpoint"), l = a.getFbeventsModules("SignalsEvents"),
                        ...
                        w = a.getFbeventsModules("SignalsFBEventsPluginManager"), x = l.on, y = l.once, z = l.trigger,
                        A = m.each;
                    l = m.FBSet;
                    m.isArray;
                    var B = m.isInteger, C = m.isEmptyObject, D = m.isNumber, E = m.keys, aa = n.logError,
                        F = n.logUserError, G = r.global, H = -1, ba = Array.prototype.slice,
                        I = Object.prototype.hasOwnProperty, J = i.href, K = !1, L = !1, M = [], N = {}, O;
                    h.referrer;
                    var P = {PageView: new l(), PixelInitialized: new l()}, Q = new p(a, N), R = new w(Q, G);
                    ...
                    function S() {
                        try {
                            ...
                            var c = v(b), d = c.args, e = c.isLegacySyntax, f = d.shift();
                            switch (f) {
                                case"addPixelId":
                                    K = !0;
                                    U.apply(this, d);
                    ...
                    function T(c) {
                        ...
                        switch (c) {
                            ...
                            case"proxy":
                                ...
                                break;
                            case"autoConfig":
                                var l = f[0], m = f[1], n = l === !0 || l === "true" ? "optIn" : "optOut";
                            ...
                            case"firstPartyCookies":
                                var o = f[0], p = f[1], r = o === !0 || o === "true" ? "optIn" : "optOut";
                                if (typeof p === "string") Q.callMethod([r, p, "FirstPartyCookies"]); else if (p === void 0) Q.disableFirstPartyCookies = !0; else throw new Error("Invalid pixelID supplied to set cookie controls.");
                                break;
                            case"experiments":
                                var t = f[0], u = [], v = E(t);
                    ...
                    function U(a, b, c) {
                        H = H === -1 ? Date.now() : H;
                        if (typeof a === "number") da(a) || F({
                            pixelID: a.toString(),
                            type: "INVALID_PIXEL_ID"
                        }), a = a.toString(); else if (typeof a === "string") {
                            var d = /^[1-9][0-9]{0,25}$/;
                            d.test(a) || F({pixelID: a, type: "INVALID_PIXEL_ID"})
                        } else if (a === void 0) F({
                            pixelID: "undefined",
                            type: "INVALID_PIXEL_ID"
                        }); else if (a === null) F({pixelID: "null", type: "INVALID_PIXEL_ID"}); else {
                    ...
                    function ea(a, b, c) {
                        ...
                        if (I.call(N, c)) {
                            for (var d = 0, e = M.length; d < e; d++) if (M[d].id === c) {
                                M[d][a] = b;
                                break
                            }
                    ...
                    function fa(a, b, c) {
                        b = b || {}, o.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), W.call(this, a, b, c)
                    }
                    ...
                    function Y(b, d) {
                        ...
                        A(d, function (a) {
                            return A(E(a), function (b) {
                                if (e.containsKey(b)) throw new Error("Custom parameter " + b + " has already been specified."); else e.append(b, a[b])
                            })
                        });
                        e.append("it", H);
                    ...
                    function Z(a) {
                        var b = a.customData, c = a.eventData, e = a.eventName;
                        a = a.pixel;
                    ...
                    function ka(a) {
                        a.instance = Q, a.callMethod = S, a._initHandlers = [], a._initsDone = {}, a.on = x, a.once = y, a.send = X, a.trigger = z, a.getEventCustomParameters = Y, a.addInitHandler = ia, a.getState = ja, a.init = U, a.set = T, a.loadPlugin = function (a) {
...
fbq.registerPlugin("global_config", {
    __fbEventsPlugin: 1, plugin: function (fbq, instance, config) {
        ...
        fbq.set("experiments", {"0": {"name": "logDataLayer", "range": [0, 0], "code": "d", "passRate": 0}});
